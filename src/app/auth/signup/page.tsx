...
export default function SignUpPage() {
  ...
  return (
    <div className="min-h-screen bg-[#f8f9fa] flex flex-col relative overflow-hidden">
      ...
      <div className="absolute -top-32 -left-32 w-64 h-64 rounded-full bg-[#006633]/5 blur-3xl pointer-events-none" />
      <div className="absolute -bottom-48 -right-48 w-96 h-96 rounded-full bg-[#006633]/5 blur-3xl pointer-events-none" />
      <div className="absolute top-1/3 right-0 w-48 h-48 rounded-full bg-[#4ade80]/5 blur-3xl pointer-events-none" />
      ...
      <div className="relative bg-[#006633] px-4 py-3 flex items-center gap-3">
        ...
        <h1 className="text-white/80 font-medium text-base">Create Account</h1>
      </div>
          ...
          {googleEnabled && (
            <>
              <a
                ...
                className="w-full h-12 rounded-xl border border-gray-300 bg-white hover:bg-gray-50 text-gray-700 text-sm font-medium flex items-center justify-center gap-3 transition-colors hover:shadow-sm"
              >
